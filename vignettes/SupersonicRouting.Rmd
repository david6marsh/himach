...
options("quiet" = 1) # anything more than 1 is messy, because of the progress bar
ap2 <- as.data.frame(matrix(c("NZAA","NZCH","NZAA","NZDN","NZGS","NZCH"), 
...
# add each route's 'advantage_h' field to the detailed segments, so that it can be mapped
routes <- routes %>% 
