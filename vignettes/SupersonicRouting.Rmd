...
It can take a very long time to construct a global grid. For our much-reduced example the time might be 2-3 seconds.
...
ap2 <- make_AP2("NZAA","NZDN",airports)

route <- findRoute(aircraft[1,], 
                     ap2,
                     onMap = NZ_buffer, 
                     pg = p_grid, 
                     apLoc = airports)
