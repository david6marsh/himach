...
Since the shape file is large, we provide a simplified outline `NZ_coast` and also the buffer `NZ_buffer30`. These are in the original projection used by Stats NZ. For global work, it's strongly recommended to use one of the following:
