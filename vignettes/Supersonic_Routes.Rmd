...
* With a 50km buffer, do you have routes passing supersonically between Taiwan and the Phillipines? Then you are missing either Y'Ami or Xiao-lan Yu, which are just 98km apart.
...
# this also saves the projection step
